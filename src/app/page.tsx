        ...
        <main className="w-full max-w-2xl mx-auto">
          ...
          {status === 'authenticated' ? (
              <>
                ...
                {scrapedData && (<div className="bg-white rounded-xl shadow-lg overflow-hidden animate-fade-in-up">
                      <div className="md:flex">
                        {scrapedData.image && (
                            <div className="md:flex-shrink-0">
                              <Image
                                  src={scrapedData.image || 'https://placehold.co/300x200/E4E4E7/71717A?text=No+Image'}
                                  alt={scrapedData.title || 'Link Image'}
                                  width={32}
                                  height={32}
